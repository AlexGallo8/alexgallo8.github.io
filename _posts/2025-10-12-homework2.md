...
*Note: This table shows a representative sample of the dataset. The complete dataset with all 31 records is available in the project repository as [security_incidents_table.csv](/assets/data/security_incidents_table.csv).*
