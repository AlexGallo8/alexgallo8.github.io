...
For this analysis, I selected the first chapter of **"The Hound of the Baskervilles"** by Sir Arthur Conan Doyle (1902), containing approximately 1,500 characters of English text.
...
3. Score using trigrams (three-letter combinations: THE, AND, ING...)
4. Trigrams are highly discriminative and catch rare letter errors

**Why this works:** Common letters drive bigram scores, but rare letters often appear in distinctive trigrams (e.g., "QUESTION" contains Q, "EXAMPLE" contains X).
...
- Accuracy improved from ~50% to **81%**
...
|-------|----------|----------|-------------|
| Initial | Frequency mapping only | 52.3% | baseline |
| Phase 2 | + Bigram optimization | 81.2% | +28.9% |
| Phase 3 | + Rare letter focus | 90.1% | +8.9% |

**Total improvement: 37.8 percentage points**
...
| Vigenère (short key) | 500 chars | ~1 minute | 95% | Yes (Kasiski) |
| AES (no mode weakness) | N/A | Infeasible | 0% | No attack exists |
...
This analysis demonstrates a critical principle in cryptography: **correct implementation is as important as algorithm selection**. Key findings:
